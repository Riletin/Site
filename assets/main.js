...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#text01', { style: 'zoom-out', speed: 2000, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text08', { style: 'zoom-out', speed: 2000, intensity: 10, threshold: 3, delay: 0, replay: false });
		onvisible.add('#links01', { style: 'zoom-out', speed: 2000, intensity: 10, threshold: 3, delay: 0, replay: false });
